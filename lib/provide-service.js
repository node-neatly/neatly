...
class ProvideService {
	 ...
	 */
	constructor(cache, injector, PROVIDER_SUFFIX) {
	 ...
	 * Provider instance will be added to _cache object.
	 *
	...
	provider(name, provider) {
		...
		return (this._cache[name + this._PROVIDER_SUFFIX] = provider);
	 ...
	 */
	constant(name, value) {
		this._cache[name] = this._cache[name + this._PROVIDER_SUFFIX] = value;
	}
